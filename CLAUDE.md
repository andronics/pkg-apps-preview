# preview - AI Assistant Instructions
...
**Description**: File Preview - Quick file content viewer

**Purpose**: Provide file preview - quick file content viewer functionality for the pkgs ecosystem.
...
**Executables**:
- `.local/bin/preview` - Main executable
- `.local/bin/preview.phase4.backup` - Main executable
...
1. **Test installation**: `stow preview`
2. **Test functionality**: Run main commands and verify output
3. **Test uninstallation**: `stow -D preview`
